 ...
 */
public class FindByDoctor extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = "select * from tb_inf where mold='医生' or '病例'";
		...
		request.getRequestDispatcher("shows_doctor.jsp").forward(request, response);
}
